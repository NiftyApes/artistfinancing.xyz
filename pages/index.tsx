  ...
  return (
    <Layout navbar={{}}>
      ...
      <div className='col-span-full mt-10 flex flex-col items-center justify-center'>
        ...
        <div className='w-full mt-[90px] mb-[90px] p-[30px]'>

          <div className='flex justify-center items-center border border-gray-700 py-[60px]'>
            <div>
              <div className='text-6xl'>Try it on Goerli</div>
              <div className='text-2xl mt-[24px] mb-[48px] text-gray-600'>Go to <span
                className='underline text-white'>sru.niftyapes.money</span> and switch your wallet network to Goerli
              </div>
              <Link href='https://niftyapes.readme.io/docs' target='_blank'>
                <div
                  className='flex flex-row items-center rounded-[10px] bg-black py-5 px-8 border border-gray-700 text-center uppercase'>
                  <span className='text-lg'>go to goerli</span>
                  <div
                    className="ml-[15px] h-[24px] w-[24px] rounded-full border border-white bg-[url('/icons/arrow-up-right.svg')] bg-center bg-no-repeat"></div>
                </div>
              </Link>
              <div className='text-gray-600 text-lg mt-[24px]'>Have questions? Reach out on <span
                className='text-white underline'>Twitter</span> or <span className='text-white underline'>Discord</span>
              </div>
            </div>
          </div>
          <div className="relative top-[-10px]">
            <img className="w-[400px]" src="https://ipfs.pixura.io/ipfs/Qmea9LPon6MkNMEmS3e2ig3LoTja92duWFpaWGvGZ5JaWe/breaker.jpg" />
          </div>
