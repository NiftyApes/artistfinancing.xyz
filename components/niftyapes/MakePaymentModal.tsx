                  ...
                  <VStack align="start" width="full" justify="space-between" gap={4}>
                    ...
                    <div className="flex flex-row items-center p-4 bg-gray-700 rounded-md justify-between w-full">
                      <div className="flex flex-row items-center gap-4 w-full">
                        ...
                        <input value={"5.07433"} type="text" className="reservoir-label-l input-primary-outline dark:border-neutral-600 dark:bg-neutral-800 dark:text-white dark:ring-primary-900 dark:placeholder:text-neutral-400  dark:focus:ring-4" />
