  ...
  return (
    <div style={{ width: `${frameSize}px`, height: `${frameSize}px` }}>
      ...
      <div
        ...
        className={`absolute border border-gray-700 bg-black text-sm opacity-85 py-[14px] px-[18px] z-50`}>
        {featuredNft.rarity}
      </div>
      <div
        style={{ marginTop: `${btmCardY}px` }}
        className={`absolute border border-gray-700 bg-black opacity-85 py-[14px] px-[18px] z-50`}>
        <div className='mb-3'>
